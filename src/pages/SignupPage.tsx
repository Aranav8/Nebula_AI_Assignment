        ...
        return (
            <div className="flex items-center justify-center h-screen bg-gray-900">
                <div className="p-8 bg-gray-800 rounded-lg shadow-xl w-full max-w-md">
                    <h2 className="text-2xl font-bold mb-6 text-center text-cyan-400">Create Account</h2>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            ...
                            <input type="text" value={username} onChange={(e) => setUsername(e.target.value)} className="w-full p-3 bg-gray-700 rounded-md border border-gray-600 focus:outline-none focus:border-cyan-500 text-white" required />
                        </div>
                        <div className="mb-4">
                        ...
                        <button type="submit" className="w-full py-3 bg-cyan-600 hover:bg-cyan-700 rounded-md font-bold transition-colors text-white">Sign Up</button>
                    </form>
